                    ...
                    <div className="pokemon-stats-container">
                        ...
                        <ul className="pokemon-stats">
                            <li className="pokemon-stat">
                                ...
                                />
                                <span className="ev-value">{pokemonTeam.hpEv}</span>
                                <input 
                                    type="range"
                                    min="0"
                                    max="31"
                                ...
                                />
                                <span className="iv-value">{pokemonTeam.hpIv}</span>
                                <span>{calculateStat(selectedPokemon.baseStats.hp, pokemonTeam.hpIv, pokemonTeam.hpEv, true)}</span>
                            </li>
                            <li className="pokemon-stat">
                                <span>Atk</span>
                                ...
                                />
                                <span className="ev-value">{pokemonTeam.atkEv}</span>
                                <input 
                                    type="range"
                                    min="0"
                                    max="31"
                                ...
                                />
                                <span className="iv-value">{pokemonTeam.atkIv}</span>
                                <span>{calculateStat(selectedPokemon.baseStats.attack, pokemonTeam.atkIv, pokemonTeam.atkEv, false)}</span>
                            </li>
                            <li className="pokemon-stat">
                                <span>Def</span>
                                ...
                                />
                                <span className="ev-value">{pokemonTeam.defEv}</span>
                                <input 
                                    type="range"
                                    min="0"
                                    max="31"
                                ...
                                />
                                <span className="iv-value">{pokemonTeam.defIv}</span>
                                <span>{calculateStat(selectedPokemon.baseStats.defense, pokemonTeam.defIv, pokemonTeam.defEv, false)}</span>
                            </li>
                            <li className="pokemon-stat">
                                <span>Sp. Atk.</span>
                                ...
                                />
                                <span className="ev-value">{pokemonTeam.spAtkEv}</span>
                                <input 
                                    type="range"
                                    min="0"
                                    max="31"
                                ...
                                />
                                <span className="iv-value">{pokemonTeam.spAtkIv}</span>
                                <span>{calculateStat(selectedPokemon.baseStats.specialAttack, pokemonTeam.spAtkIv, pokemonTeam.spAtkEv, false)}</span>
                            </li>
                            <li className="pokemon-stat">
                                <span>Sp. Def.</span>
                                ...
                                />
                                <span className="ev-value">{pokemonTeam.spDefEv}</span>
                                <input 
                                    type="range"
                                    min="0"
                                    max="31"
                                ...
                                />
                                <span className="iv-value">{pokemonTeam.spDefIv}</span>
                                <span>{calculateStat(selectedPokemon.baseStats.specialDefense, pokemonTeam.spDefIv, pokemonTeam.spDefEv, false)}</span>
                            </li>
                            <li className="pokemon-stat">
                                <span>Speed</span>
                                ...
                                />
                                <span className="ev-value">{pokemonTeam.spdEv}</span>
                                <input 
                                    type="range"
                                    min="0"
                                    max="31"
                                ...
                                />
                                <span className="iv-value">{pokemonTeam.spdIv}</span>
                                <span>{calculateStat(selectedPokemon.baseStats.speed, pokemonTeam.spdIv, pokemonTeam.spdEv, false)}</span>
                            </li>
                        </ul>
                    </div>
